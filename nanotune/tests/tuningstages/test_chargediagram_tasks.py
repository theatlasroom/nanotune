...
def test_segment_dot_data(db_dot_tuning, tmp_path):
    ...
    assert bool(ds.data.dc_current.voltage_x[0] == dot_segments[1]['voltage_ranges'][0][0])
    assert bool(ds.data.dc_current.voltage_y[0] == dot_segments[1]['voltage_ranges'][1][0])
